        ...
        UserApiClient.getInstance().me(new Function2<User, Throwable, Unit>() {
            ...
            public Unit invoke(User user, Throwable throwable) {
                if (user != null) {
                    ...
                    myInfo.setKakaoId(String.valueOf(user.getId()));
                    myInfo.setEmail(user.getKakaoAccount().getEmail());
                    myInfo.setNickname(user.getKakaoAccount().getProfile().getNickname());
